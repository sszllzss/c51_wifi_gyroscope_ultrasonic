...
static timer_interrupt_cb_t data timer0_int_cb = NULL;
static timer_interrupt_cb_t data timer1_int_cb = NULL;
static timer_interrupt_cb_t data timer2_int_cb = NULL;
static timer_interrupt_cb_t data timer3_int_cb = NULL;
static timer_interrupt_cb_t data timer4_int_cb = NULL;
/********************* Timer0中断函数************************/
